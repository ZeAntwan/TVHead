...
musiclist[0] = file_find_first(working_directory + "music/*.ogg",0);
if (musiclist[0] != "") {
...
// FIX FOR BUFFER BUG IN RECENT RUNTIMES
repeat(samples*channels*2) buffer_write(buffer, buffer_u8, 0);
